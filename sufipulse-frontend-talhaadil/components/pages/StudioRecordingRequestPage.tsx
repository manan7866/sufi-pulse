...
import { Mic, Calendar, Clock, Music, CheckCircle, Info } from 'lucide-react';
import StudioRecordingRequestForm from './StudioRecordingRequestForm';
import MyStudioRequestsList from './MyStudioRequestsList';

type ViewType = 'form' | 'my-requests';

const StudioRecordingRequest: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4">
              ...
              <span className="block text-emerald-400 mt-2">In-Person Session</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Request an in-person studio session at SufiPulse Studio for your approved lyric.
              Our professional team will work with you to capture the perfect vocal performance.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {currentView === 'form' ? (
          <StudioRecordingRequestForm onSuccess={handleSuccess} />
        ) : (
          <MyStudioRequestsList key={refreshKey} />
        )}
      </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm sm:text-base text-slate-700">
                <li className="flex items-start space-x-2">
                  ...
                  <span>After submission, your request will be reviewed by our studio team</span>
                </li>
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-4 h-4 text-emerald-600 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start space-x-2">
                  <CheckCircle className="w-4 h-4 text-emerald-600 mt-0.5 flex-shrink-0" />
                  <span>Our team will coordinate with you for the final session schedule</span>
                </li>
              </ul>
            </div>
          </div>
...
export default StudioRecordingRequest;
